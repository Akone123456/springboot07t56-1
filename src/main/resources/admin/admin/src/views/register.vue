  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='yunshugongsi'" class="input-group">
			   <div class="label">公司编号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.gongsibianhao" class="input" type="text" placeholder="公司编号">
			   </div>
			 </div> -->
			<el-form-item label="公司编号" class="input" v-if="tableName=='yunshugongsi'">
			  <el-input v-model="ruleForm.gongsibianhao" autocomplete="off" placeholder="公司编号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yunshugongsi'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='yunshugongsi'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='yunshugongsi'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="公司名称" class="input" v-if="tableName=='yunshugongsi'">
			...
			<el-form-item label="公司地址" class="input" v-if="tableName=='yunshugongsi'">
			...
			<el-form-item label="负责人" class="input" v-if="tableName=='yunshugongsi'">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='yunshugongsi'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.gongsibianhao) && `yunshugongsi` == this.tableName){
        this.$message.error(`公司编号不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `yunshugongsi` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `yunshugongsi` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if((!this.ruleForm.gongsimingcheng) && `yunshugongsi` == this.tableName){
        this.$message.error(`公司名称不能为空`);
        return
      }
      if(`yunshugongsi` == this.tableName && this.ruleForm.lianxidianhua&&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){
