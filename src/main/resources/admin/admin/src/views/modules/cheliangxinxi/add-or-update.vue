<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车架号" prop="chejiahao">
          <el-input v-model="ruleForm.chejiahao" 
              placeholder="车架号" clearable  :readonly="ro.chejiahao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="车架号" prop="chejiahao">
              <el-input v-model="ruleForm.chejiahao" 
                placeholder="车架号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="载重量" prop="zaizhongliang">
          <el-input v-model="ruleForm.zaizhongliang" 
              placeholder="载重量" clearable  :readonly="ro.zaizhongliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="载重量" prop="zaizhongliang">
              <el-input v-model="ruleForm.zaizhongliang" 
                placeholder="载重量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="里程" prop="licheng">
          <el-input v-model="ruleForm.licheng" 
              placeholder="里程" clearable  :readonly="ro.licheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="里程" prop="licheng">
              <el-input v-model="ruleForm.licheng" 
                placeholder="里程" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.cheliangleixing = true;
          ...
          if(o=='chejiahao'){
            this.ruleForm.chejiahao = obj[o];
	    this.ro.chejiahao = true;
            continue;
          }
          if(o=='zaizhongliang'){
            this.ruleForm.zaizhongliang = obj[o];
	    this.ro.zaizhongliang = true;
            continue;
          }
          if(o=='licheng'){
