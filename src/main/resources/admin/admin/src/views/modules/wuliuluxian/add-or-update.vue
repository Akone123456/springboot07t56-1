<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="起点地址" prop="qidiandizhi">
          <el-input v-model="ruleForm.qidiandizhi" 
              placeholder="起点地址" clearable  :readonly="ro.qidiandizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="起点地址" prop="qidiandizhi">
              <el-input v-model="ruleForm.qidiandizhi" 
                placeholder="起点地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="到达地址" prop="daodadizhi">
          <el-input v-model="ruleForm.daodadizhi" 
              placeholder="到达地址" clearable  :readonly="ro.daodadizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="到达地址" prop="daodadizhi">
              <el-input v-model="ruleForm.daodadizhi" 
                placeholder="到达地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="路线详情" prop="luxianxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.luxianxiangqing" label="路线详情" prop="luxianxiangqing">
                    <span v-html="ruleForm.luxianxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.luxianmingcheng = true;
          ...
          if(o=='qidiandizhi'){
            this.ruleForm.qidiandizhi = obj[o];
	    this.ro.qidiandizhi = true;
            continue;
          }
          if(o=='daodadizhi'){
            this.ruleForm.daodadizhi = obj[o];
	    this.ro.daodadizhi = true;
            continue;
          }
          if(o=='wuliudanjia'){
	...
	this.ruleForm.luxianxiangqing = this.ruleForm.luxianxiangqing.replace(reg,'../../../springboot07t56/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `wuliuluxian/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.wuliuluxianCrossAddOrUpdateFlag = false;
						 this.parent.search();
