<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="路线名称" prop="luxianmingcheng">
          <el-input v-model="ruleForm.luxianmingcheng" 
              placeholder="路线名称" clearable  :readonly="ro.luxianmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="路线名称" prop="luxianmingcheng">
              <el-input v-model="ruleForm.luxianmingcheng" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="物流单价" prop="wuliudanjia">
          <el-input v-model="ruleForm.wuliudanjia" 
              placeholder="物流单价" clearable  :readonly="ro.wuliudanjia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="物流单价" prop="wuliudanjia">
              <el-input v-model="ruleForm.wuliudanjia" 
                placeholder="物流单价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="运单状态" prop="yundanzhuangtai">
          <el-select :disabled="ro.yundanzhuangtai" v-model="ruleForm.yundanzhuangtai" placeholder="请选择运单状态">
            <el-option
                v-for="(item,index) in yundanzhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="运单状态" prop="yundanzhuangtai">
	      <el-input v-model="ruleForm.yundanzhuangtai"
                placeholder="运单状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="收货人姓名" prop="shouhuorenxingming">
          <el-input v-model="ruleForm.shouhuorenxingming" 
              placeholder="收货人姓名" clearable  :readonly="ro.shouhuorenxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="收货人姓名" prop="shouhuorenxingming">
              <el-input v-model="ruleForm.shouhuorenxingming" 
                placeholder="收货人姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="车辆编号" prop="cheliangbianhao">
          <el-select :disabled="ro.cheliangbianhao" v-model="ruleForm.cheliangbianhao" placeholder="请选择车辆编号">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="公司编号" prop="gongsibianhao">
          <el-input v-model="ruleForm.gongsibianhao" 
              placeholder="公司编号" clearable  :readonly="ro.gongsibianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="公司编号" prop="gongsibianhao">
              <el-input v-model="ruleForm.gongsibianhao" 
                placeholder="公司编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	wuliudanjia : false,
	zongjia : false,
	yundanzhuangtai : false,
	shouhuorenxingming : false,
	lianxidianhua : false,
  ...
  computed: {
    ...
    zongjia:{
      get: function () {
        return 1*this.ruleForm.zhongliang*this.ruleForm.wuliudanjia
      }
    },
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhongliang = true;
          ...
          if(o=='wuliudanjia'){
            this.ruleForm.wuliudanjia = obj[o];
	    this.ro.wuliudanjia = true;
            continue;
          }
          if(o=='zongjia'){
	    ...
	    this.ro.zongjia = true;
          ...
          if(o=='yundanzhuangtai'){
            this.ruleForm.yundanzhuangtai = obj[o];
	    this.ro.yundanzhuangtai = true;
            continue;
          }
          if(o=='shouhuorenxingming'){
            this.ruleForm.shouhuorenxingming = obj[o];
	    this.ro.shouhuorenxingming = true;
            continue;
          }
          if(o=='lianxidianhua'){
	    ...
	    this.ro.shouji = true;
          ...
          if(o=='gongsibianhao'){
            this.ruleForm.gongsibianhao = obj[o];
	    this.ro.gongsibianhao = true;
            continue;
          }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.gongsibianhao!=''&&json.gongsibianhao){
                this.ruleForm.gongsibianhao = json.gongsibianhao
	    		this.ro.gongsibianhao = true;
		}
		if(json.gongsimingcheng!=''&&json.gongsimingcheng){
          ...
          this.$message.error(data.msg);
            ...
            this.yundanzhuangtaiOptions = "待发货,运输中,已送达".split(',')
            this.$http({
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yundanxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yundanxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
