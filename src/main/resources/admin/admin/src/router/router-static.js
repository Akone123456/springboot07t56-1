...
import center from '@/views/center'
    ...
    import wuliuluxian from '@/views/modules/wuliuluxian/list'
    import huowuxinxi from '@/views/modules/huowuxinxi/list'
    import yunshugongsi from '@/views/modules/yunshugongsi/list'
